...
import { IoLocationOutline, IoArrowDown, IoBicycleSharp } from "react-icons/io5";
      ...
      <div className="relative  w-full   ">
        ...
        <div className="absolute inset-0 flex flex-col   justify-center text-white   w-[clamp(100vm,100vw,100vw)]       h-[clamp(400px,90vh,800px)]  pl-[clamp(1vw,10vw,10vw)]    ">
          ...
          <div className="flex flex-wrap gap-6 mt-10 pointer-events-auto md:justify-start">
            <button className="group relative overflow-hidden h-[clamp(4rem,2vh,1rem)]   w-[clamp(20rem,15vw,16rem)] bg-blue-500 text-[clamp(1.3rem,1.6vw,1.6rem)] flex items-center justify-center uppercase rounded-full backdrop-blur-md text-white shadow-md border-0 transition-all duration-500">
              <span className="z-10">Explore Tour</span>
            ...
            <button className="group relative overflow-hidden  h-[clamp(4rem,2vh,1rem)]   w-[clamp(20rem,15vw,16rem)]  text-[clamp(1.3rem,1.6vw,1.6rem)] flex items-center justify-center uppercase rounded-full bg-transparent border-white text-white shadow-md border transition-all duration-500">
        ...
        <div className="absolute top-1/2 right-10 -translate-y-1/2 flex-col items-center gap-2 hidden lg:flex">
          ...
          {[0, 1, 2].map((index) => (
            <button
              ...
              className={`h-[50px] w-[1px] transition-all duration-300 ${currentIndex === index ? "bg-black" : "bg-white hover:bg-green-500"}`}
            />
          ))}
